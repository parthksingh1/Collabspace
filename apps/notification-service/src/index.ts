...
import { KafkaNotificationConsumer } from './kafka/consumer.js';
...
app.listen(config.port, () => {
  logger.info(`Notification service running on port ${config.port} [${config.nodeEnv}]`);
});

const consumer = new KafkaNotificationConsumer();
